              ...
              <CardHeader className="space-y-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 lg:flex-nowrap">
                  <div className="min-w-0 flex-1 basis-[min(100%,20rem)] sm:min-w-[12rem]">
                    <label htmlFor="admin-integrity-election" className="sr-only">
                      Election
                    </label>
                    <select
                  ...
                  {/* Refresh button — moved here from inside the verification card so toolbar
                      controls all live in one place */}
                  <div className="flex w-full shrink-0 flex-wrap items-center gap-2 sm:w-auto sm:justify-end sm:ml-auto">
                    <Button
                      ...
                      disabled={integrityLoading || !electionId}
                    >
                      <RefreshCw className={`mr-2 h-4 w-4 ${integrityLoading ? "animate-spin" : ""}`} />
                      Refresh
                    </Button>
                  </div>
                </div>
