...
const defaultCryptoPath = path.resolve(__dirname, '../../..', 'fabric-network-ecasvote', 'organizations', 'peerOrganizations', 'org1.example.com');
// Path to crypto materials (Org1 = SEB for test-network-ecasvote)
const cryptoPath = envOrDefault('CRYPTO_PATH', defaultCryptoPath);
